...
export const passwordForget = async (req, res) => {
  ...
  try {
    ...
    await transport.sendMail({
      ...
      text: `You requested a password reset. Open this link to choose a new password: ${resetUrl.toString()}\n\nThis link is valid for 15 minutes.`,
    });
...
export const passwordReset = async (req, res) => {
  ...
  try {
    ...
    if (!checkEmail.passwordResetToken || !checkEmail.passwordResetExpires) {
      return res.status(400).json({ error: "Invalid email or token." });
    }
