...
import { getNotes, getArchivedNotes, archiveNote, restoreNote, searchNotes, getNotesByTag, getNoteById, createNote, updateNote, getTags, deleteNote } from "../controllers/notesController.js";
...
router.patch("/restore/:id", verifyToken, restoreNote);
