...
const Settings = () => {
      ...
      <div className="selection-cards">
        {[
          ...
          },
          {
            ...
            icon: "icon-system-theme.svg",
          },
        ].map((item) => (
          <button
            type="button"
            key={item.id}
            className={`selection-card ${theme === item.id ? "active" : ""}`}
          ...
          >
            ...
            <div
              className={`radio-dot ${theme === item.id ? "selected" : ""}`}
            ></div>
          </button>
        ))}
      </div>
  ...
  const FontSettings = () => (
    <>
      ...
      <div className="selection-cards">
        {[
          ...
          <button
            type="button"
            key={item.id}
            className={`selection-card ${font === item.id ? "active" : ""}`}
          ...
          >
            ...
            <div
              className={`radio-dot ${font === item.id ? "selected" : ""}`}
            ></div>
          </button>
        ))}
      </div>
      <button
        className="apply-btn"
        onClick={() => handleApplyTheme("font", font)}
      >
        Apply Changes
      </button>
    </>
      ...
      <form className="password-form" onSubmit={handlePasswordSubmit}>
        <div className="form-group">
          ...
          <div className="input-with-icon">
            ...
            >
              <img
                src={`/assets/images/icon-${showPass.old ? "hide" : "show"}-password.svg`}
                alt="eye"
              />
            </button>
          </div>
        ...
        <div className="form-group">
          ...
          <div className="input-with-icon">
            ...
            >
              <img
                src={`/assets/images/icon-${showPass.next ? "hide" : "show"}-password.svg`}
                alt="eye"
              />
            </button>
          </div>
        ...
        <div className="form-group">
          ...
          <div className="input-with-icon">
            ...
            >
              <img
                src={`/assets/images/icon-${showPass.confirm ? "hide" : "show"}-password.svg`}
                alt="eye"
              />
            </button>
          </div>
  ...
  return (
    <div className="settings-page-wrapper">
      ...
      <div
        className={`settings-sidebar ${subview !== "main" ? "hidden-mobile" : ""}`}
      >
      ...
      <div
        className={`settings-content-panel ${subview === "main" ? "hidden-mobile" : ""}`}
      >
